...
const FlightContainer = (props) => {
  ...
  const fetchCurrentItinerary = async () => {
    try {
      ...
      toast.error("Failed to fetch itineraries, please try again", {
        toastId: "error-itinerary",
      });
    }
  };
